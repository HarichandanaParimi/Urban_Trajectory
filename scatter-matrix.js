...
ScatterMatrix.prototype.render = function () {
  ...
  this.onData(function() {
    ...
    // variables has to be divied into string and numeric variables
    ...
    // controls are added on the left
    ...
    function set_filter(variable) {
      ...
      if (variable) {
        //  unique values for the  variable
        var values = [];
        data.forEach(function(d) {
          var v = d[variable];
...
ScatterMatrix.prototype.__draw =
  ...
  this.onData(function() {
    ...
    // Ti highlight th eregions of data
    ...
    // previously-active brush has to be cleared
    ...
    // selected circles are to be highlighted
    function brush(p) {
      var e = brush.extent();
    ...
    // select all the circles if brush is empty,
    function brushend() {
